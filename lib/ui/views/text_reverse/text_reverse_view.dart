...
class TextReverseView extends StackedView<TextReverseViewModel>
  ...
  void onViewModelReady(TextReverseViewModel viewModel) {
    ...
    reverseInputFocusNode.addListener(() {
      if (!reverseInputFocusNode.hasFocus) {
        viewModel.validateReverseText();
      }
    });
  }
  ...
  Widget builder(
    ...
    return Scaffold(
        appBar: AppBar(title: const Text("Text reversed")),
        backgroundColor: Theme.of(context).colorScheme.background,
        body: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            verticalSpaceMedium,
            const Text('Text to Reverse',
